...
CAPITULOS = {
    "ato1_cap1_dia": {
        ...
        "tem_escolhas": False,
        "frames": [
            # Tela preta antes de qualquer frame
            {
                "imagem": None,
                "tipo_texto": "narrador",
                "texto": "Era uma terça-feira comum. Molly acabou de chegar da escola."
            },
            # Molly_1
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_1.png",
                "tipo_texto": "narrador",
                "texto": "Ela ainda estava de mochila. O celular já estava na mão antes mesmo de sentar."
            },
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_1.png",
                "tipo_texto": "narrador",
                "texto": "Tinha tirado a foto no intervalo. Ajustou o filtro por quinze minutos antes de postar."
            },
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_1.png",
                "tipo_texto": "molly",
                "texto": "Ficou boa. Ficou, né?"
            },
            # Molly_2
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_2.png",
                "tipo_texto": "narrador",
                "texto": "Ela abriu o aplicativo. 32 curtidas. 10 minutos. O número ficou parado na cabeça dela."
            },
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_2.png",
                "tipo_texto": "narrador",
                "texto": "Parecia pouco. Ou era bom pra 10 minutos? Ela não sabia mais."
            },
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_2.png",
                "tipo_texto": "molly",
                "texto": "As pessoas que importam nem curtiram ainda."
            },
            # Molly_3
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_3.png",
                "tipo_texto": "narrador",
                "texto": "Ela foi olhar a foto de novo. O ângulo. O filtro. Algo estava errado."
            },
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_3.png",
                "tipo_texto": "molly",
                "texto": "Os olhos. São sempre os olhos."
            },
            # Molly_4
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_4.png",
                "tipo_texto": "narrador",
                "texto": "Ela desviou o olhar. Não era pra tela — era pra lugar nenhum."
            },
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_4.png",
                "tipo_texto": "molly",
                "texto": "Queria que eu fosse assim. Do jeito que o filtro faz."
            },
            # Molly_5
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_5.png",
                "tipo_texto": "narrador",
                "texto": "Ela trocou o filtro. Melhorou. Pelo menos era o que ela achava."
            },
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_5.png",
                "tipo_texto": "molly",
                "texto": "Assim está melhor. Assim parece mais... eu."
            },
            # Molly_6
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_6.png",
                "tipo_texto": "narrador",
                "texto": "Ela postou. O coração acelerou um pouco quando apertou o botão."
            },
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_6.png",
                "tipo_texto": "narrador",
                "texto": "Mas ela apertou."
            },
            {
                "imagem": "journey/ato_1/Cap_1(dia)/Molly_6.png",
                "tipo_texto": "molly",
                "texto": "Agora é só esperar."
            },
        ]
    },
    "ato1_cap2_noite": {
...
def processar_escolha(cap_id, cena_num, opcao_index, barra_atual):
    ...
    if opcao_index < len(opcoes):
        ...
        return max(0, min(10, barra_atual + delta))
    return barra_atual
